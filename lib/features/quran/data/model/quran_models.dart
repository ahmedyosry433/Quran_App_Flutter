...
class DataFromJson {
  late final List<Surah> surah;
  DataFromJson({required this.surah});

  factory DataFromJson.fromJson(Map<String, dynamic> json) {
    return DataFromJson(
      surah: List<Surah>.from(json['surahs'].map((x) => Surah.fromJson(x))),
    );
  }
}
